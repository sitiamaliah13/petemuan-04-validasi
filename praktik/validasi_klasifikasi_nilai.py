...
teks_hadir = input (" Nilai kehadiran (0-100):").strip()
...
try:
    ...
    print("Masukan ditolak: semua nilai harus berupa angka.")
else:
    if not (0 <= ujian <= 100):
        print("Masukan ditolak; nilai ujian diluar rentang 0 sampai 100.")
    elif not (0 <= tugas <= 100):
        print("Masukan ditolak; nilai tugas diluar rentang 0 sampai 100.")
    elif not (0 <= hadir <= 100):
        print(" Masukan ditolak: nlai kehadiran diluar rentang 0 sampai 100.")
    else:
